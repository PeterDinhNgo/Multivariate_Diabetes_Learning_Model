function [positive_likelihood, negative_likelihood, training_pos_prior, training_neg_prior, test_error, mean_trainingPos, cov_trainingPos, mean_trainingNeg, cov_trainingNeg] = Classifier(cov_matrix_type, x, discriminant_type)
